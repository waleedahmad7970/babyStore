...
export default function DeliveryService() {
  return (
    <div className="flex w-full items-center justify-center bg-[#1D4983] py-[10px] text-white md:bg-[#1D4983] md:py-0">
      {featuresData.map((feature: Feature, index: number) => (
        <div
          key={feature.id}
          className={`flex w-full flex-col items-center gap-[5px] p-[10px] md:flex-row md:justify-center md:px-[60px] md:py-5 ${
