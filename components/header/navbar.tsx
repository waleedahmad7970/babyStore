        ...
        <div className="flex w-full justify-between md:w-auto md:items-center">
          ...
          <div className="relative">
            ...
            {cartProducts?.length > 0 && (
              <span className="absolute top-[-5px] right-[-6px] flex h-4 w-4 items-center justify-center rounded-full border border-white bg-[#ff4747] text-[10px] font-bold text-white md:hidden">
                {totalQuantity || 0}
              </span>
            )}
          </div>
